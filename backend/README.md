...
## Project Structure
    ...
    ├── testapiautodatamod_102681  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_102681`
...
2. Clone this repo and `cd testapiautodatamod_102681`
